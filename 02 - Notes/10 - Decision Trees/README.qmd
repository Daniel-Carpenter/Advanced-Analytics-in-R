...
-   Evaluate impurity with Misclassification rate, Entropy, Information Gain, Information Gain Ratio and Gini Index

-   Compare and contrast the different impurity measures

-   Build classification trees in R

-   Improve your classification trees by using tree ensembles techniques: Bagging, Random Forests and Boosting

### Pros of Decision Trees

![](images/paste-43A68596.png){width="550"}

![](images/paste-1A6563CD.png){width="550"}

### Cons of Decision Trees

-   Overly complex

-   Model changes depending on input data. So difficult to explain to management
...
![](images/paste-A7D7A647.png){width="550"}

![](images/paste-11EB79BD.png){width="550"}

![](images/paste-B8B1FC87.png){width="550"}

## General Ideas

### Interpretation of Decision Trees

![](images/paste-CB66EC9C.png){width="550"}

Algorithm idea:

![](images/paste-1BCA4E66.png){width="550"}

### Constructing Trees (Induction)

![](images/paste-47A4AD18.png){width="550"}

![](images/paste-6C8F67C9.png){width="550"}

![](images/paste-B80E61CD.png){width="550"}
...
![](images/paste-11794188.png){width="550"}

### Method 1 - Using Misclassificatin Rate

-   Note do not use the misclassification rate

-   In practice, we do not use this. It is a greedy technique, only making the best decision based on a given iteration.

![](images/paste-1DEE8B6F.png){width="550"}

![](images/paste-FBA65C0C.png){width="550"}

![](images/paste-7E350799.png){width="550"}
...
![](images/paste-CE94A4BD.png){width="550"}

### Method 3 - Information Gain

![](images/paste-3CB63AA7.png){width="550"}

### Method 4 - Information Gain *Ratio*

![](images/paste-073C1C41.png){width="550"}

### Method 5 - Gini Index

![](images/paste-F90DABD7.png){width="550"}

## Tree Algorithms

### Concepts

### ![](images/paste-E2B31A82.png){width="550"}

### R Packages

![](images/paste-8FE74B2A.png){width="550"}
...
![](images/paste-528517A9.png){width="550"}

![](images/paste-6BDCF01E.png){width="550"}

![](images/paste-B4DE4CF1.png){width="550"}

### Complexity

-   Number of leaf nodes indicate the complexity of the tree (called `CP` in R)

![](images/paste-5AE5F797.png){width="550"}
...
![](images/paste-E819962E.png){width="550"}

![](images/paste-F56C143F.png){width="550"}

### Bagging

-   Cannot interpret since average of multiple models

![](images/paste-EE0EE87F.png){width="550"}

![](images/paste-5E3B3A8D.png){width="550"}

Example of bagging 3 models:

![](images/paste-9937B573.png){width="550"}
...
![](images/paste-533A1C08.png){width="550"}

Want to de-correlate by tuning hyper-parameter `p`

![](images/paste-1078BDF0.png){width="550"}
...
![](images/paste-15E6CD2E.png){width="550"}

#### Most Popular Boosting Method: `AdaBoost`

![](images/paste-F623E08A.png){width="550"}

![](images/paste-55EE876E.png){width="550"}

![](images/paste-750EDCBB.png){width="550"}
