...
![](images/paste-8B6D62E8.png){width="550"}

## How to Transform Skewness

> Approach 1: Take the `log` of the skewed variable

![](images/paste-568DB390.png){width="550"}

![](images/paste-A9BC2A9E.png){width="550"}

### Example 1 (Concepts)

![](images/paste-C1688B8C.png){width="550"}
...
![](images/paste-C6E2955B.png){width="550"}

![](images/paste-823FC445.png){width="550"}

![](images/paste-E0295AF4.png){width="550"}

### Questions for Feature Extraction

![](images/paste-9780FA40.png){width="550"}

![](images/paste-52B63335.png){width="550"}
