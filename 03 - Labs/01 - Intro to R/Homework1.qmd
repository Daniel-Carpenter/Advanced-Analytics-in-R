...
(b) Use the following vector y for this part: 
```{r}
y <- c(3,12,99,99,7,99,21)
```

i. Some statistical applications and older systems sometimes code missing values with a number,
...
ii. With the updated vector y, write code that will count the number of missing values in it.