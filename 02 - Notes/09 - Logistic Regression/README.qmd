...
-   Compare and contrast Multiple Linear Regression and Logistic Regression

-   Build logistic regression models and interpret the results

-   Evaluate classification performance with confusion matrices, ROC curves, concordant pairs, K-S charts, and cumulative gains

-   Fit your logistic regression models with lasso or elastic net regularization

## Summary

-   Classifier based on dichotomous Outcomes (Success or Failure, binary)

-   Need a model that bounds between 0 and 1

-   To keep above 1: Odds:

    -   ![](images/paste-C5DBB6E7.png){width="244"}

-   To keep above 0:

    -   ![](images/paste-4B097CEB.png){width="550"}

## General Setup

### Classification Rule

![](images/paste-2C852966.png){width="550"}

Example

![](images/paste-15A34A76.png){width="550"}

### Example in R

![](images/paste-53A0055E.png){width="550"}
