...
+-------------------+------------------------------------------------------------------+
| Covariance Matrix | ![](images/paste-E4390E88.png){width="512"}                      |
+-------------------+------------------------------------------------------------------+
| Solution to PCA   | Make a judgement call on the % of variation that you contain     |
|                   |                                                                  |
|                   | ![](images/paste-76E5BAE4.png){width="391"}                      |
|                   |                                                                  |
|                   | ![](images/paste-63633851.png){width="375"}                      |
+-------------------+------------------------------------------------------------------+
| Normalization     | Each Attribute should contribute equally to the overall variance |
|                   |                                                                  |
|                   | ![](images/paste-158F08ED.png){width="550"}                      |
+-------------------+------------------------------------------------------------------+
