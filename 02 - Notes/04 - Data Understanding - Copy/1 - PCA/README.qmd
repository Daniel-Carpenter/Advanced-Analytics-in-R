...
+-------------------+------------------------------------------------------------------+
| Variance          | ![](images/paste-BD5F3A4E.png)                                   |
+-------------------+------------------------------------------------------------------+
| Covariance Matrix | ![](images/paste-E4390E88.png)                                   |
+-------------------+------------------------------------------------------------------+
| Solution to PCA   | Make a judgement call on the % of variation that you contain     |
|                   |                                                                  |
|                   | ![](images/paste-76E5BAE4.png)                                   |
|                   |                                                                  |
|                   | ![](images/paste-63633851.png)                                   |
+-------------------+------------------------------------------------------------------+
| Normalization     | Each Attribute should contribute equally to the overall variance |
|                   |                                                                  |
|                   | ![](images/paste-158F08ED.png)                                   |
+-------------------+------------------------------------------------------------------+

## Conceptual Example of PCA

![](images/paste-925C48F1.png){width="1152"}

### Two possible principal components:

![](images/paste-4D02DAD2.png){width="1196"}
